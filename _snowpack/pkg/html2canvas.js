...
var CanvasRenderer = function() {
  ...
  CanvasRenderer2.prototype.renderNodeContent = function(paint) {
    return __awaiter(this, void 0, void 0, function() {
      var container, curves, styles, _i, _a, child, image2, image2, iframeRenderer, canvas, size, bounds, x, textBounds, img, image2, url, bounds;
      return __generator(this, function(_b) {
        switch (_b.label) {
          case 0:
        ...
        switch (_b.label) {
          case 0:
            ...
            _loop_1 = function(backgroundImage3) {
              var image2, url, _a2, path, x, y, width, height, pattern, _b2, path, x, y, width, height, _c, lineLength, x0, x1, y0, y1, canvas, ctx, gradient_1, pattern, _d, path, left, top_1, width, height, position2, x, y, _e, rx, ry, radialGradient_1, midX, midY, f2, invF;
